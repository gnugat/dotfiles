...
mkdir -p "${HOME}/.suite_py"
ln -nsf \
    "${_SSDF_PACKAGE_DIR}/config/config.yml" \
    "${HOME}/.suite_py/config.yml"
ln -nsf \
    "${_SSDF_PACKAGE_DIR}/config/boot.suite-py.sh" \
    "${HOME}/.suite_py/boot.suite-py.sh"
